...
std::shared_ptr<RenderEngine::Sprite> getSpriteForDescription(const char description)
{
    ...
    case 'F':
        return nullptr;
    default:
        std::cerr << "Error::StartScreen::getSpriteForDescription -> Unknown Start Level description: " << description << std::endl;
    }
    return nullptr;
}
...

{
    ...
    {
        std::cerr << "Error::StartScreen::StartScreen ->Empty start screen description!" << std::endl;
    }
