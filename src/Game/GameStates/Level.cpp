...
void Level::initPhysics()
{
	...
	m_enemyTanks.emplace(std::make_shared<Tank>(Tank::ETankType::EnemyGreen_type2, true, false, Tank::EOrientation::Bottom, 0.05, getEnemyRespawn_2(), glm::vec2(Level::BLOCK_SIZE, Level::BLOCK_SIZE), 0.f));
	m_enemyTanks.emplace(std::make_shared<Tank>(Tank::ETankType::EnemyGreen_type4, true, false, Tank::EOrientation::Bottom, 0.05, getEnemyRespawn_3(), glm::vec2(Level::BLOCK_SIZE, Level::BLOCK_SIZE), 0.f));
