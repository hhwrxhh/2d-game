...
public:
	...
	static std::shared_ptr<Renderer::Texture> loadTexture(const std::string& textureName,
														  const std::string& texturePath);
	static std::shared_ptr<Renderer::Texture> getTexture(const std::string& textureName);
	static std::shared_ptr<Renderer::Texture> loadTextureAtlas(std::string textureName,
